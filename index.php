...
<head>
  ...
  <title>INICIAR SESION - CONALEP TABASCO</title>
</head>
...
<body>
  <section class="vh-100">
    ...
    <div class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 conalep">
      <!-- Copyright -->
      <div class="text-white mb-3 mb-md-0 ">
        Proyecto de Tutorias - FASE DE DESARROLLO - Kevin Gabriel Rodriguez Mayo / Dra. Lizbeth Jacinto Castillo
      </div>
      <!-- -->
  ...
  <script type="text/javascript">
    //Javascript a traves de Jquery Funcionando
  </script>
</body>
